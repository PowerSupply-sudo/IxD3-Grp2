...
public class questionnaireFE {
    ...
    public static Pane createContent(Runnable onBack) {
        ...
        // 1. The Title
        Label title = new Label("Questionnaire for wish");
...
//infoaboutwish also holds the CSS for questionnaire, makes the most sense since questionnaire is a popup on top of infoaboutwish